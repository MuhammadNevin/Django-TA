...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Agus Zainal Arifin\Documents\KP\image-classification\image-classification-house\8_django_implementation\django-TA\api-server-django'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Agus Zainal Arifin\Documents\KP\image-classification\image-classification-house\8_django_implementation\django-TA\api-server-django\Scripts\deactivate.nu'
